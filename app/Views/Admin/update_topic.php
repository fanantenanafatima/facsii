...
<body>
	<div class="form_field">
		...
		<form action="<?= base_url('Topics/update_it/').$topic['id'];?>" enctype="multipart/form-data" method="post">
			<div class="ttl">Modifier la publication</div>
			<input type="text" name="title_topic" id="title_topic" value="<?= $topic['title'];?>">
			<textarea name="topic_body"  id="topic_body" ><?= $topic['body'];?></textarea>
			<div style="text-align: center; margin-top: 6px; color : red;"><i>Vous devez reinserer l'image.</i></div>
