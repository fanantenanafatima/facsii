...
<body>
	<div class="user_champ_login">
		<div class="frm0">
		    <form action="<?php echo base_url('Home/save_count'); ?>" method="post">
                ...
                <div>
                    <span><i class="fa-regular fa-user icon"></i></span>
                    <input type="text" name="user_fname" placeholder="Prénom" size="50" />
                </div>
				<span style="color:#dc3545; text-decoration:  none; font-size: 12px; margin-left:15px;">
                ...
                <div>
                    ...
                    <input type="text" name="nce" placeholder="Carte d'etudiant N°" size="50" ?>
                </div>
				<span style="color:#dc3545; text-decoration:  none; font-size: 12px; margin-left:15px;">
		     ...
		     <hr>
		     <a href=" <?php echo base_url('Home/login'); ?>">Vous avez déja un compte?</a>
